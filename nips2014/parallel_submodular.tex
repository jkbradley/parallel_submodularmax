...
The first, `hogwild' approach emphasizes speed at the cost of a weaker approximation guarantee;
the second 'OCC' approach provides strong approximation guarantees at the cost of greater coordination.
We show that our parallel algorithms scale well on synthetic and real datasets, and suffer little or no loss of objective value compared to the sequential algorithm.
\end{abstract}
