...
\begin{itemize}
\item Motivate parallel machine learning from big data setting
\item Briefly mention two approaches (coordination-free, concurrency control)
\item In this paper, we focus on unconstrained non-monotone submodular maximization.. and say briefly why this problem is important
\item Contributions of the paper
\begin{enumerate}
