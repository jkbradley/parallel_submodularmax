  ...
  \begin{multicols}{2}
    \begin{minipage}{0.49\textwidth}
      ...
      \begin{algorithm}[H]
        ...
        \If {$u_e < \frac{[\Delta_+^{\text{exact}}(e)]_+}{[\Delta_+^{\text{exact}}(e)]_+ + [\Delta_-^{\text{exact}}(e)]_+}$}{\label{alg:occvalidate:decisioninclude}
    ...
    \begin{minipage}{0.49\textwidth}
      \begin{algorithm}[H]
        ...
        \ParForAll{$p \in \set{1, \ldots, P}$}{
          \While{$\exists$ element to process}{
            ...
            \lIf {result$(i) = 0$} {validate($e$, $i$)}
            processAndRollback($e$, $i$)\;
          }
        }
      \end{algorithm}
      ...
      \begin{algorithm}[H]
        \DontPrintSemicolon
        \caption{\occ{}: processAndRollback($e$, $i$)}
        \label{alg:occrollback}
        \If {result$(i) = 1$}{
