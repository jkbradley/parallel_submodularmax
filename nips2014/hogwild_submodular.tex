  ...
  \begin{tabular}{cccc}
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/runtime_bigsynthetic_maxgraphcut.png}
			\caption{}
			\label{fig:runtime_bigsynthetic_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/runtime_zigzag_setcover.png}
			\caption{}
			\label{fig:runtime_zigzag_setcover}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/runtime_uk2005_maxgraphcut.png}
			\caption{}
			\label{fig:runtime_uk2005_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/runtime_arabic2005_setcover.png}
			\caption{}
			\label{fig:runtime_arabic2005_setcover}
	  \end{subfigure} \\
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/speedup_bigsynthetic_maxgraphcut.png}
			\caption{}
			\label{fig:speedup_bigsynthetic_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/speedup_zigzag_setcover.png}
			\caption{}
			\label{fig:speedup_zigzag_setcover}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/speedup_uk2005_maxgraphcut.png}
			\caption{}
			\label{fig:speedup_uk2005_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/speedup_arabic2005_setcover.png}
			\caption{}
			\label{fig:speedup_arabic2005_setcover}
	  \end{subfigure} \\
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/diffFA_Hogwild_bigsynthetic_maxgraphcut.png}
			\caption{}
			\label{fig:diffFA_Hogwild_bigsynthetic_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/diffFA_Hogwild_zigzag_setcover.png}
			\caption{}
			\label{fig:diffFA_Hogwild_zigzag_setcover}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/diffFA_Hogwild_uk2005_maxgraphcut.png}
			\caption{}
			\label{fig:diffFA_Hogwild_uk2005_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/diffFA_Hogwild_arabic2005_setcover.png}
			\caption{}
			\label{fig:diffFA_Hogwild_arabic2005_setcover}
	  \end{subfigure} \\
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/validated_OCC_bigsynthetic_maxgraphcut.png}
			\caption{}
			\label{fig:validated_OCC_bigsynthetic_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/validated_OCC_zigzag_setcover.png}
			\caption{}
			\label{fig:validated_OCC_zigzag_setcover}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/validated_OCC_uk2005_maxgraphcut.png}
			\caption{}
			\label{fig:validated_OCC_uk2005_maxgraphcut}
	  \end{subfigure} &
	  \begin{subfigure}[b]{0.22\textwidth}
	  	\includegraphics[width=110pt]{images/validated_OCC_arabic2005_setcover.png}
			\caption{}
			\label{fig:validated_OCC_arabic2005_setcover}
	  \end{subfigure} \\
  \end{tabular}
  \caption{\footnotesize Experimental results.
  Average runtimes are shown on the first row (\ref{fig:runtime_bigsynthetic_maxgraphcut}, \ref{fig:runtime_zigzag_setcover}, \ref{fig:runtime_uk2005_maxgraphcut}, \ref{fig:runtime_arabic2005_setcover}).
  Average speedups are shown on the second row (\ref{fig:speedup_bigsynthetic_maxgraphcut}, \ref{fig:speedup_zigzag_setcover}, \ref{fig:speedup_uk2005_maxgraphcut}, \ref{fig:speedup_arabic2005_setcover}).
  The median difference between $F(A)$ given by hogwild and the sequential algorithm is shown on the third row (\ref{fig:diffFA_Hogwild_bigsynthetic_maxgraphcut}, \ref{fig:diffFA_Hogwild_zigzag_setcover}, \ref{fig:diffFA_Hogwild_uk2005_maxgraphcut}, \ref{fig:diffFA_Hogwild_arabic2005_setcover}).
  The median fraction of elements validated by OCC is shown on the fourth row (\ref{fig:validated_OCC_bigsynthetic_maxgraphcut}, \ref{fig:validated_OCC_zigzag_setcover}, \ref{fig:validated_OCC_uk2005_maxgraphcut}, \ref{fig:validated_OCC_arabic2005_setcover}).
  The columns show the results for the
  random Erdos-Renyi (\ref{fig:runtime_bigsynthetic_maxgraphcut}, \ref{fig:speedup_bigsynthetic_maxgraphcut}, \ref{fig:diffFA_Hogwild_bigsynthetic_maxgraphcut}, \ref{fig:validated_OCC_bigsynthetic_maxgraphcut}),
  ZigZag (\ref{fig:runtime_zigzag_setcover}, \ref{fig:speedup_zigzag_setcover}, \ref{fig:diffFA_Hogwild_zigzag_setcover}, \ref{fig:validated_OCC_zigzag_setcover}),
  UK-2005 (\ref{fig:runtime_uk2005_maxgraphcut}, \ref{fig:speedup_uk2005_maxgraphcut}, \ref{fig:diffFA_Hogwild_uk2005_maxgraphcut}, \ref{fig:validated_OCC_uk2005_maxgraphcut}), and
  Arabic-2005 (\ref{fig:runtime_arabic2005_setcover}, \ref{fig:speedup_arabic2005_setcover}, \ref{fig:diffFA_Hogwild_arabic2005_setcover}, \ref{fig:validated_OCC_arabic2005_setcover}) graphs.
  }
\label{fig:results}
\end{figure}
...
We tested the max graph cut and set cover problems on two synthetic graphs and three real datasets (Table \ref{tab:graphstats}).
...
Due to space constraints, we only present part of our results in Figure \ref{fig:results}, deferring full results to Appendix \ref{app:exptresults}.
...
\textbf{Validations:} The OCC algorithm validates more elements as threads are added, but less than 0.0125\% are validated with 16 threads, which has negligible effect on the runtime / speedup.
